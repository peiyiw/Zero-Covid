# Zero-Covid
Code for: Criteria for maintenance of the Zero-COVID strategy in mainland China: a large-scale modelling study
...
It takes about 3 hours to fit the model and 10 minitures to run a simulation on a machine with the recommended specs.
